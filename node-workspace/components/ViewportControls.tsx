...
export const ViewportControls: React.FC<Props> = ({
  ...
  return (
    <div className="flex items-center gap-3 h-9 px-3 rounded-full border border-white/10 bg-[#0d0f12]/90 text-white shadow-[0_10px_30px_rgba(0,0,0,0.4)] backdrop-blur min-w-[320px]">

...
const BASE_INSTRUCTION = [
  ...
  "For project lookup, prefer list_project_resources to inspect available episodes or understanding coverage before reading detailed content.",
  "For concrete reading, prefer read_project_resource. Use it for episode_script, scene_script, project_summary, and episode_summary.",

...
const BASE_INSTRUCTION = [
  ...
  "When creating a text-to-image workflow, connect the text node tail to the imageGen node head, which means source_handle=text and target_handle=text.",
  "Current default connection matrix: text -> text uses text/text, and text -> imageGen uses text/text.",
